        ...
        <section id="projects" ref={sectionRef} className="relative py-24 md:py-32 px-4 sm:px-6">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div style={getRevealStyle(isVisible, "fade-up", 0)}>
                    ...
                    <p className="text-gray-500 max-w-2xl text-base sm:text-lg mb-12 md:mb-20">
                                ...
                                <div className="glass-card p-5 sm:p-8 md:p-10">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-8">
                                        ...
                                        <div className="flex gap-3 shrink-0">
                                            <a href={project.github} className="px-5 py-2.5 rounded-xl glass text-sm text-gray-300 hover:text-white hover:bg-white/10 flex items-center gap-2" style={{ transitionProperty: "background-color, color", transitionDuration: "0.2s" }}>
                                            ...
                                            {project.demo && (
                                                <a
                                                    href={project.demo}
                                                    className={`px-5 py-2.5 rounded-xl text-sm font-medium text-white flex items-center gap-2 ${project.color === "purple"
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-4 mb-8">
                                        {project.highlights.map((h, hIdx) => (
                                            <div
                                                key={h.title}
                                                className="p-5 rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/10 group"
                                                style={{
                                                    ...getRevealStyle(isVisible, "scale-in", idx * 200 + hIdx * 100 + 400),
                                            ...
                                            >
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div>
                                                        <h4 className="font-semibold text-white text-sm mb-1 group-hover:text-purple-300" style={{ transitionProperty: "color", transitionDuration: "0.2s" }}>
                                                            {h.title}
                                                        </h4>
                                    ...
                                    {project.architecture && (
                                        <div className="mb-8" style={getRevealStyle(isVisible, "fade-up", idx * 200 + 800)}>
                                            ...
                                            <div className="overflow-x-auto -mx-2 sm:mx-0 flex flex-wrap items-center gap-2 p-4 sm:p-6 rounded-xl bg-white/[0.02] border border-white/5">
